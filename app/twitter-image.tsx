...
export const alt = `${siteConfig.name} — Digital experiences, designed and engineered`;
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 120, fontWeight: 600, letterSpacing: -6, lineHeight: 0.95 }}>Build</div>
          <div style={{ display: "flex", fontSize: 120, fontWeight: 600, letterSpacing: -6, lineHeight: 0.95 }}>
            {"what's"}&nbsp;<span style={{ color: "#d4ff3f", fontStyle: "italic" }}>next.</span>
          </div>
        </div>
        <div style={{ fontSize: 28, color: "#a0a19a" }}>{siteConfig.tagline}</div>
      </div>
    ),
    size,
  );
